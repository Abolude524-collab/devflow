...
export async function getGithubAuthUrlController(request: FastifyRequest, reply: FastifyReply) {
  try {
...
export async function githubCallbackController(request: FastifyRequest, reply: FastifyReply) {
...
export async function getGithubAccountController(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
...
export async function getUserGithubReposController(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
...
export async function linkProjectGithubRepoController(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
...
export async function unlinkProjectGithubRepoController(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
    const { projectId } = projectParamsSchema.parse(request.params);
...
export async function getProjectGithubIntegrationController(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
    const { projectId } = projectParamsSchema.parse(request.params);
...
export async function getTaskGithubActivitiesController(request: FastifyRequest, reply: FastifyReply) {
  try {
    await request.jwtVerify();
...
export async function githubWebhookController(request: FastifyRequest, reply: FastifyReply) {
  try {
